...
export default function BeitragInhaltWohngeld() {
    ...
    return (
        <div className="abstand2">
            ...
            <h1 className="überschrift1">Wohngeld Beantragung</h1>
            ...
            <p className="text">Dort erhalten Sie auch die Antragsformulare sowie nähere Auskünfte. Antragsformulare zum Ausdrucken werden ebenfalls auf dieser Seite bereitgestellt.</p>

        ...
        <div className="abstand2">
            ...
            <details>
                ...
                <p className="text">Zu der persönlichen Antragstellung bringen Sie bitte Ihren Ankunftsnachweis und alle wichtigen Dokumente und Unter­lagen mit, die Sie besitzen. <br /> <br />
                    ...
                    Teilen Sie uns auch mit, ob sich bereits Familienangehörige in Deutschland aufhalten, wo diese wohnen und ob sie sich auch im Asylverfahren befinden oder befanden. Wenn Sie Ihren Asylantrag gestellt haben, erhalten Sie für die Dauer Ihres Asylverfahrens eine Aufenthaltsgestattung. Tragen Sie diese immer bei sich.
                </p>
            </details>
            ...
            <details>
                ...
                <p className="text">Doch bevor Ihr Verfahren startet, müssen wir feststellen, ob Deutschland oder ein anderer europäischer Staat für die Prüfung Ihres Asylantrags zuständig ist.<br /> <br />
                    ...
                    Sie können gegen diese Entscheidung klagen. Achten Sie dabei auf die genannten Fristen im Schreiben. Sie sollten dabei eine Anwältin oder einen Anwalt hinzuziehen.</p>
            </details>
            ...
            <details>
                ...
                <p className="text">Wenn Deutschland für Ihren Asylantrag zuständig ist, findet eine Anhörung beim Bundesamt statt.<br /> <br />
                    Sie werden dann direkt im Ankunftszentrum nach der Antrag­sstellung zu Ihren Fluchtgründen angehört oder Sie erhalten später schriftlich einen Termin zu Ihrer persönlichen Anhörung. Diesen Termin müssen Sie unbedingt persönlich wahrnehmen.<br /> <br />
                    ...
                    Bei der Anhörung befragen wir Sie zu Ihren Fluchtgründen. Unsere Mitarbeitenden sind mit den Umständen in Ihrem Herkunftsland vertraut.<br /> <br />
                    Es steht ihen ebenfalls eine Dolmetscherin oder ein Dolmetscher bei Seite und übersetzt alles, was Sie sagen. Sie dürfen auch eine Vertrauensperson als Beistand mitbringen. <br /> <br />
                ...
                <p className="text">Ihre gesamte Anhörung wird in einem Protokoll aufgenommen und Ihnen mündlich rückübersetzt. Sie können diese korrigieren oder ergänzen.<br /> <br />
                ...
                <div className="infotextasyl">Zu Beginn des Asylverfahrens wohnen Sie in einer Aufnahmeeinrichtung. 
                    Es kann sein, dass Sie bis zur Entscheidung über Ihren Antrag dort bleiben oder in eine andere Unterkunft umziehen werden. Sollten Sie umziehen, müssen Sie dem Bundesamt, der Ausländerbehörde und eventuell dem Gericht Ihre neue Anschrift mitteilen. Dies ist enorm wichtig, da die Briefe immer an die letzte Anschrift gesendet werden, die den Behörden mitgeteilt wurde.</div>
            </details>
            <details>

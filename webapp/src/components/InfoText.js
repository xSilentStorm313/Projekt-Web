...
export default function InfoText() {
    return (
        <div>
            ...
            <p><img src={icon2} className="icon" alt="icon" align="left" /><p className="texthome"> Informationen zu neuen Gesetzen und Nachrichten mit Relevanz für Geflüchtete</p></p>

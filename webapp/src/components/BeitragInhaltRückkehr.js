    ...
    return (
        <div className="abstand">
            ...
            <details>
                ...
                <p className="text">Diese kann Sie ggf. über weitere bestehende Unterstützungsmöglichkeiten durch die einzelnen Bundesländer informieren. Bitte beachten Sie, dass eine Antragstellung nur über eine antragsübermittelnde Stelle möglich ist.
